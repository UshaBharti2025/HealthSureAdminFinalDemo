...
<body>
    ...
    <h:panelGroup rendered="#{not empty facesContext.messageList and !facesContext.validationFailed}" 
                 styleClass="notification" id="successNotification">
    ...
    <div class="content-container">
        <h:form id="recipientForm" prependId="false" styleClass="form-container">
            <div class="form-title">Update Recipient Details</div>
            
            <!-- Show message if recipient is not selected -->
            <h:panelGroup rendered="#{empty recipientController.recipient}" styleClass="message-container">
                <h:outputText value="Please select a recipient first from the search page." 
                              style="color: red; font-weight: bold;" />
            </h:panelGroup>
            ...
            <h:panelGroup rendered="#{not empty recipientController.recipient}">
                ...
                <div class="form-group">
                    ...
                    <div class="required-wrapper">
                        <h:inputText id="mobile" value="#{recipientController.recipient.mobile}" 
                                     required="true" requiredMessage="Mobile number is required" maxlength="10" />
                    </div>
                    <h:message for="mobile" styleClass="error-msg" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="required-wrapper">
                        <h:inputText id="address" value="#{recipientController.recipient.address}" 
                                     required="true" requiredMessage="Address is required" maxlength="150" />
                    </div>
                    <h:message for="address" styleClass="error-msg" />
                </div>
                ...
                <!-- Update (left) & Discard (right) on same line -->
                <div class="button-row">
                    <h:commandButton value="Update Recipient" action="#{recipientController.updateRecipient}" 
                                     styleClass="btn btn-blue" />
                    <h:commandButton value="Discard Changes" onclick="showModal(); return false;" 
                                     styleClass="btn btn-gray" />
                </div>

                <!-- Back to Search & Dashboard navigation-->
                <div class="link-group">
                    <h:commandButton value="Back to Search" action="#{recipientController.goToSearch}" 
                                     styleClass="btn btn-gray" />
                    <h:commandButton value="Dashboard" action="#{recipientController.goToDashboard}" 
                                     styleClass="btn btn-gray" />
                </div>
            </h:panelGroup>
        </h:form>
    ...
    <div id="confirmResetModal" class="modal-overlay">
        <div class="modal-content">
            ...
            <div style="margin-top: 20px;">
                <h:form>
                    <h:commandButton value="Yes, Discard" action="#{recipientController.resetUpdate}" 
                                     styleClass="btn btn-blue" immediate="true" onclick="hideModal()"/>
                    <button class="btn btn-gray" onclick="hideModal(); return false;">Cancel</button>
                </h:form>
            </div>
        </div>
    </div>
