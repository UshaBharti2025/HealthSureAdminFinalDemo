...
<head>
    ...
    <style>
        body {
            background-color: #f1f8f6; /* Light blue background to match search page */
            font-family: Arial, sans-serif;
            margin: 0;
            padding: 0;
        }
        ...
        .form-container {
            background: white;
            padding: 40px;
            border-radius: 12px; /* Rounded corners like search page */
            box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1); /* Softer shadow */
        }
        .form-title {
            text-align: center;
            color: #000080; /* Dark navy blue like search page */
            margin-bottom: 24px;
            margin-top: 25px;
            font-size: 24px;
            font-weight: bold;
        ...
        .form-group input[type="text"] {
            width: 100%;
            padding: 10px 12px;
            border: 2px solid #003366; /* Border color like search page */
            border-radius: 8px; /* Rounded corners like search page */
            font-size: 14px;
            outline: none;
        }
        .form-group input[readonly] {
       ...
       /* Button styling with rounded corners */
        ...
        .link-group .btn {
            background-color: #003366; /* Navy blue for bottom buttons */
            color: white;
            border-radius: 8px; /* Rounded corners like search page */
        }
...
<body>
    ...
    <div class="form-container">
        ...
        <h:form prependId="false" id="mainForm">
            <!-- Health ID with Fetch button -->
            <div class="form-group">
                <h:outputLabel for="searchHid" value="Health ID:" styleClass="required"/>
                <div class="hid-fetch-group">
                    <div class="required-wrapper">
        ...
        <h:form styleClass="link-group">
            <h:commandButton value="Back to Search Page" 
                             action="#{recipientController.goToSearch}" 
                             styleClass="btn" immediate="true" />
            <h:commandButton value="⬅️ Back to Dashboard" action="/admin/Admin_Dashboard_Recipient?faces-redirect=true" 
                                 styleClass="back-btn" immediate="true" />
    ...
    <h:panelGroup id="toastWrapper" layout="block" style="display:none;">
        <h:messages id="globalMessages" globalOnly="true" layout="table" 
                   styleClass="toast-message" 
                   infoClass="toast-info" 
                   errorClass="toast-error" 
                   warnClass="toast-warn"/>
    </h:panelGroup>
